**Moore-French Machine Translation: Corpus Construction, Dataset Preparation, and Model Adaptation**
...
This project investigates the development of a Mooré-to-French machine translation pipeline in a low-resource setting, with a particular focus on Mooré, a low-resource African language spoken primarily in Burkina Faso and neighboring countries.

The project followed a complete data-to-model workflow, encompassing data collection, corpus construction, manual correction and alignment, dataset adaptation, model fine-tuning using AutoScientist, and subsequent benchmarking. The resulting parallel corpus contains 1,176 aligned Mooré–French segments. The corpus combines educational and community-oriented texts produced in Guiè, Burkina Faso, with additional bilingual materials and Mooré–French biblical texts.
...
The objective of this project was therefore not simply to collect Mooré text, but to construct a usable Mooré–French parallel corpus and use it to develop and evaluate a model adapted to the specific translation direction:
...
- Fine-tune Meta Llama 3.3 70B Instruct using AutoScientist and LoRA.
...
> adaption_llama_3_3_70b_instru_moore_french_parallel_58863825
...
The extracted adapter_model.safetensors file contained 1,120 tensors, confirming that the trained adapter weights were present and structurally consistent with the LoRA configuration.
...
This project developed and tested an end-to-end workflow for Mooré–French machine translation in a low-resource setting, covering the process from corpus construction and dataset preparation to model fine-tuning and benchmarking.
